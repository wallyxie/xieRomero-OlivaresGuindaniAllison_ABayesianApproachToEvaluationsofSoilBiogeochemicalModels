...
CON_fit1 <- stan("CON_adriana_pools4p1.stan", data = CON_dat1, iter = 60000, warmup = 20000, refresh = 1, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.99, stepsize = 0.01, max_treedepth = 15))
...
CON_fit2 <- stan("CON_adriana_pools4p1.stan", data = CON_dat2, iter = 60000, warmup = 20000, refresh = 1, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.99, stepsize = 0.01, max_treedepth = 15))
...
CON_fit3 <- stan("CON_adriana_pools4p1.stan", data = CON_dat3, iter = 60000, warmup = 20000, refresh = 1, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.99, stepsize = 0.01, max_treedepth = 15))
...
CON_fit4 <- stan("CON_adriana_pools4p1.stan", data = CON_dat4, iter = 60000, warmup = 20000, refresh = 1, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.99, stepsize = 0.01, max_treedepth = 15))
...
CON_fit5 <- stan("CON_adriana_pools4p1.stan", data = CON_dat5, iter = 60000, warmup = 20000, refresh = 1, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.99, stepsize = 0.01, max_treedepth = 15))
...
CON_fit6 <- stan("CON_adriana_pools4p1.stan", data = CON_dat6, iter = 60000, warmup = 20000, refresh = 1, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.99, stepsize = 0.01, max_treedepth = 15))
...
CON_fit7 <- stan("CON_adriana_pools4p1.stan", data = CON_dat7, iter = 60000, warmup = 20000, refresh = 1, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.99, stepsize = 0.01, max_treedepth = 15))
