...
# CON_fitTest <- stan("CON_adriana_pools5i.stan", data = CON_dat1, iter = 200, refresh = 10, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.95, stepsize = 0.1, max_treedepth = 12))
...
CON_fit2 <- stan("CON_adriana_pools5i.stan", data = CON_dat2,  iter = 35000, warmup = 10000, refresh = 10, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.95, stepsize = 0.1, max_treedepth = 12))
...
CON_fit7 <- stan("CON_adriana_pools5i.stan", data = CON_dat7,  iter = 35000, warmup = 10000, refresh = 10, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.95, stepsize = 0.1, max_treedepth = 12))
