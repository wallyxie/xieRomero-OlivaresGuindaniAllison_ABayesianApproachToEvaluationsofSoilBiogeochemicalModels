...
filename = "AWB_adriana_pools5i_vary_mic"
...
AWB_fit1 <- stan("AWB_adriana_pools5i.stan", data = AWB_dat1, iter = 45000, warmup = 20000, refresh = 10, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.99, stepsize = 0.1, max_treedepth = 12))
saveRDS(AWB_fit1, paste(format(Sys.time(),"%Y_%m_%d_%H_%M"), filename, "stanfit", "S", S_0, "D", D_0, "M", M_01, "E", E_0, ".rds", sep = "_"))
...
AWB_fit3 <- stan("AWB_adriana_pools5i.stan", data = AWB_dat3, iter = 45000, warmup = 20000, refresh = 10, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.99, stepsize = 0.1, max_treedepth = 12))
saveRDS(AWB_fit3, paste(format(Sys.time(),"%Y_%m_%d_%H_%M"), filename, "stanfit", "S", S_0, "D", D_0, "M", M_03, "E", E_0, ".rds", sep = "_"))
...
AWB_fit4 <- stan("AWB_adriana_pools5i.stan", data = AWB_dat4, iter = 45000, warmup = 20000, refresh = 10, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.99, stepsize = 0.1, max_treedepth = 12))
saveRDS(AWB_fit4, paste(format(Sys.time(),"%Y_%m_%d_%H_%M"), filename, "stanfit", "S", S_0, "D", D_0, "M", M_04, "E", E_0, ".rds", sep = "_"))
...
AWB_fit5 <- stan("AWB_adriana_pools5i.stan", data = AWB_dat5, iter = 45000, warmup = 20000, refresh = 10, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.99, stepsize = 0.1, max_treedepth = 12))
saveRDS(AWB_fit5, paste(format(Sys.time(),"%Y_%m_%d_%H_%M"), filename, "stanfit", "S", S_0, "D", D_0, "M", M_05, "E", E_0, ".rds", sep = "_"))
...
AWB_fit6 <- stan("AWB_adriana_pools5i.stan", data = AWB_dat6, iter = 45000, warmup = 20000, refresh = 10, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.99, stepsize = 0.1, max_treedepth = 12))
saveRDS(AWB_fit6, paste(format(Sys.time(),"%Y_%m_%d_%H_%M"), filename, "stanfit", "S", S_0, "D", D_0, "M", M_06, "E", E_0, ".rds", sep = "_"))
