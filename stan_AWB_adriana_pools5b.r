...
bayes_diagnostics = function(stan_fit, S_0, D_0, M_0, E_0, filename) {
    ...
    ggsave(paste(format(Sys.time(),"%Y_%m_%d_%H_%M"), filename, "trace", "S", S_0, "D", D_0, "M", M_0, "E", E_0, ".pdf", sep = "_"), plot = traceplot1)
    ggsave(paste(format(Sys.time(),"%Y_%m_%d_%H_%M"), filename, "trace", "S", S_0, "D", D_0, "M", M_0, "E", E_0, ".png", sep = "_"), plot = traceplot1)
    #Autocorrelation
    ...
    acf_plot2 <- mcmc_acf(stan_fit.array, pars = c("V_ref", "E_C_ref", "a_MS")) + yaxis_text() + theme(axis.text = element_text(size = 16), axis.title = element_text(size = 20))
    ggsave(paste(format(Sys.time(),"%Y_%m_%d_%H_%M"), filename, "acf_V_ref", "S", S_0, "D", D_0, "M", M_0, "E", E_0, ".pdf", sep = "_"), plot = acf_plot2)
    acf_plot3 <- mcmc_acf(stan_fit.array, pars = c("V_U_ref")) + yaxis_text() + theme(axis.text = element_text(size = 16), axis.title = element_text(size = 20))
    ggsave(paste(format(Sys.time(),"%Y_%m_%d_%H_%M"), filename, "acf_V_U_ref", "S", S_0, "D", D_0, "M", M_0, "E", E_0, ".pdf", sep = "_"), plot = acf_plot3)
    acf_plot4 <- mcmc_acf(stan_fit.array, pars = c("m_t")) + yaxis_text() + theme(axis.text = element_text(size = 16), axis.title = element_text(size = 20))
...
AWB_fit1 <- stan("AWB_adriana_pools5.stan", data = AWB_dat1, iter = 40000, warmup = 15000, refresh = 1, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.9995, stepsize = 0.001, max_treedepth = 15))
...
AWB_fit2 <- stan("AWB_adriana_pools5.stan", data = AWB_dat2, iter = 40000, warmup = 15000, refresh = 1, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.9995, stepsize = 0.001, max_treedepth = 15))
...
AWB_fit3 <- stan("AWB_adriana_pools5.stan", data = AWB_dat3, iter = 40000, warmup = 15000, refresh = 1, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.9995, stepsize = 0.001, max_treedepth = 15))
...
AWB_fit4 <- stan("AWB_adriana_pools5.stan", data = AWB_dat4, iter = 40000, warmup = 15000, refresh = 1, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.9995, stepsize = 0.001, max_treedepth = 15))
...
AWB_fit5 <- stan("AWB_adriana_pools5.stan", data = AWB_dat5, iter = 40000, warmup = 15000, refresh = 1, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.9995, stepsize = 0.001, max_treedepth = 15))
...
AWB_fit6 <- stan("AWB_adriana_pools5.stan", data = AWB_dat6, iter = 40000, warmup = 15000, refresh = 1, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.9995, stepsize = 0.001, max_treedepth = 15))
...
AWB_fit7 <- stan("AWB_adriana_pools5.stan", data = AWB_dat7, iter = 40000, warmup = 15000, refresh = 1, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.9995, stepsize = 0.001, max_treedepth = 15))
