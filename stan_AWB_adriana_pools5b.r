...
# AWB_fitTest <- stan("AWB_adriana_pools5.stan", data = AWB_datTest, iter = 1000, refresh = 1, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.999, stepsize = 0.001, max_treedepth = 15))
...
AWB_fit2 <- stan("AWB_adriana_pools5.stan", data = AWB_dat2, iter = 80000, warmup = 30000, refresh = 1, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.999, stepsize = 0.001, max_treedepth = 15))
...
AWB_fit7 <- stan("AWB_adriana_pools5.stan", data = AWB_dat7, iter = 80000, warmup = 30000, refresh = 1, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.999, stepsize = 0.001, max_treedepth = 15))
