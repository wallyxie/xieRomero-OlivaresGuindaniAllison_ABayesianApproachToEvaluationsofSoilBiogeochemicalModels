...
bayes_diagnostics = function(stan_fit, S_0, D_0, M_0, E_0, filename) {
    ...
    ggsave(paste(format(Sys.time(),"%Y_%m_%d_%H_%M"), filename, "trace_Ea", "S", S_0, "D", D_0, "M", M_0, "E", E_0, ".pdf", sep = "_"), plot = traceplot1)
    ggsave(paste(format(Sys.time(),"%Y_%m_%d_%H_%M"), filename, "trace_Ea", "S", S_0, "D", D_0, "M", M_0, "E", E_0, ".png", sep = "_"), plot = traceplot1)
...
AWB_fit2 <- stan("AWB_adriana_pools5.stan", data = AWB_dat2, iter = 45000, warmup = 20000, refresh = 1, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.9995, stepsize = 0.001, max_treedepth = 15))
...
AWB_fit7 <- stan("AWB_adriana_pools5.stan", data = AWB_dat7, iter = 45000, warmup = 20000, refresh = 1, chains = 4, seed = 1234, open_progress = "False", control = list(adapt_delta = 0.9995, stepsize = 0.001, max_treedepth = 15))
